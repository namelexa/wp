 ...
 */
function icraft_is_plugin_installed($pluginTitle)
{
    // get all the plugins
...
function icraft_plugin_install($plugin_slug)
{
...
function icraft_plugin_activation( $plugin, $slug, $plugin_filename ) {
	if ( strpos( $plugin, '/' ) ) {
