...
<div  class="wrapper site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'open-store' ); ?></a>
			...
			<div class="container">
				<div class="pull-left">
					<div class="contact-info">
						...
						<div class="call-info">
							<a href="callto:<?php echo esc_attr($top_phone); ?>" class="info-link call-us-link"><i class="fa fa-phone"></i><?php echo esc_html($top_phone); ?> </a>
						</div>
						<?php endif; ?>
						<?php $top_email = get_theme_mod('storeone_top_email'); if(!empty($top_email)): ?>
						<div class="mail-info">
							<a href="mailto:<?php echo esc_attr($top_email); ?>" class="info-link mail-us-link"><i class="fa fa-envelope"></i><?php echo esc_html($top_email); ?> </a>
						</div>
						<?php endif; ?>
					</div>
				</div>
					...
					<div class="mbs-accout-links pull-left">
						<div class="dropdown">
						  <button class="btn btn-myaccout dropdown-toggle" type="button" id="MyAccountDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
						    <?php _e('My Account', 'open-store') ?>
						    <span class="caret"></span>
						  </button>
						  <?php echo open_store_get_page_links_html(); ?>
						</div>
					</div>
				</div>
