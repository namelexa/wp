					...
					<div class="storefront-enhance__column storefront-free-plugins">
						...
						<ul class="storefront-free-plugins__wrap">
							<li class="storefront-plugin">
								<h6><?php esc_attr_e( 'Cart Tab', 'storefront' ); ?></h6>
								<p>
...
' );
							...
							<li class="storefront-plugin">
								<h6><?php esc_attr_e( 'Product Sharing', 'storefront' ); ?></h6>
								<p>
							...
							<li class="storefront-plugin">
								<h6><?php esc_attr_e( 'Sticky add to cart', 'storefront' ); ?></h6>
								<p>
					...
					<div class="storefront-enhance__column storefront-child-themes">
						<h5><?php esc_attr_e( 'Alternate designs', 'storefront' ); ?></h5>
